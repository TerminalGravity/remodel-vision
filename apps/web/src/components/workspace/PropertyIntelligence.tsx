        ...
        {activePropertyContext && (
          <div className="bg-gradient-to-r from-blue-900/30 to-purple-900/30 border border-blue-500/30 rounded-xl p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className={`text-xs px-2 py-1 rounded-full border ${activePropertyContext.metadata?.dataQuality === 'estimated' ? 'bg-yellow-500/10 text-yellow-500 border-yellow-500/20' : 'bg-blue-500/10 text-blue-400 border-blue-500/20'}`}>
                {activePropertyContext.metadata?.dataQuality === 'estimated' ? 'AI Estimated' : 'Verified Records'}
              </span>
            </div>
